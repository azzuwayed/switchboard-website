...
- `index.html` + `pricing.html` + `checkout.html` + `success.html` +
  `privacy.html` + `style.css` + `assets/` — the English GitHub Pages landing
  site, pricing, purchase, license-key, and privacy pages.
- `ar/index.html` + `ar/pricing.html` + `ar/checkout.html` +
  `ar/success.html` + `ar/privacy.html` — Arabic (RTL) mirror of the public
  pages, sharing the same `style.css` via sibling-relative links. See
  "Localized pages" below.
...
- Every English copy edit must be mirrored to the matching Arabic page in
  ...
  automatic propagation. Purchase pages must also keep return/cancel URLs
  localized through the license Worker's `locale` checkout field.
...
`ar/index.html`, `ar/pricing.html`, `ar/checkout.html`, `ar/success.html`, and
`ar/privacy.html` in sync — add new HTML pages to the `HTML_PAGES` list at the
top of the script.
